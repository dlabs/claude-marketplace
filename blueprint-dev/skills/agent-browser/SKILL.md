...
**DO NOT use Chrome MCP tools (mcp__claude-in-chrome__*) or Playwright MCP tools (mcp__plugin_playwright_playwright__*) when this skill is active.**

This skill uses the `agent-browser` CLI exclusively. It is a Bash-based tool from Vercel that runs headless Chromium. It is NOT the same as browser automation via MCP.
